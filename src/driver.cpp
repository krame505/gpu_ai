...
int main(int argc, char **argv) {
  ...
  desc.add_options()
    ...
    ("player1,1", boost::program_options::value<string>(), "player 1 (mode = single)\nhuman random mcts mcts_host mcts_device_single mcts_device_heuristic mcts_device_multiple mcts_device_relaunch mcts_hybrid\ntest 1 (mode = test)\nhost device_single device_heuristic device_multiple device_relaunch hybrid")
